...
cl.login(token="EnUID46e3yzwPx08Z7h7.nWCvXRBPwCS6U8LKp+/GbW.3nRPRju3ZjKxpxz5uB34DOB1nP1sQuG2ilOUF41vFLE=")
cl.loginResult()

ki = LINETCR.LINE() #Zorro
ki.login(token="En83cleKrc1em6RxXdv4.0EZ5pdSZ0EnDErfj9f0Rva.ocEvRYeIjEr3ppTK8M6ZGBtdkciUrXyOFP38Hzgr1hg=")
ki.loginResult()

kk = LINETCR.LINE() #Sanji
kk.login(token="Encg0NMAqFlpCFU0pDtc.J0Q8blLEqw2bGfsLwI2Spa./z8qbs6/VAU9yo1iYFiHEdNSOj1B1ROIS4R4BPtSekU=")
kk.loginResult()

kc = LINETCR.LINE() #Ussop
kc.login(token="En6GNucT7oR3oBFOkHwd.NfbBKogtKFQGDCzZK7McNq.RxrhbOa7B1ELq5HJtVOrbM0p30WltS/HsgZperzGnso=")
kc.loginResult()

ks = LINETCR.LINE() #Chooper
ks.login(token="Enu3Nzy82QfWdbohlIT1.A2StFdJX3gbgsdOS4lfsWq.Bpa1VBAyyWSlKgjvEYlHIVWCqQUUFNCUo6vCd9t7BhI=")
ks.loginResult()
...
Bots=[mid,Amid,Bmid,Cmid,Dmid,"u95b2e9d6cb4d2af7786116bcffa70c30","uc77c9c633647cb63309ba9d2f80fe3f0","ucb7306058e6c26cd7347aa3403161e33","uac8db0c95892f660c63b374380afbdc6","u45577af489fbde1932bec5d5a65d1f2d","u016cc25b78015339655b9b5c8b208aca","ueb11b4931b1ac3bf000550e189bf831c"]
admin=["u95b2e9d6cb4d2af7786116bcffa70c30","uc77c9c633647cb63309ba9d2f80fe3f0","ucb7306058e6c26cd7347aa3403161e33","uac8db0c95892f660c63b374380afbdc6","u45577af489fbde1932bec5d5a65d1f2d","u016cc25b78015339655b9b5c8b208aca","ueb11b4931b1ac3bf000550e189bf831c"]
              ...
              if msg.from_ in owner:
                ...
                if targets == []:
                   ...
                   for target in targets:
                        try:
                            admin.append(target)
                            cl.sendText(msg.to,"Admin Bot Add")
                        except:
                            pass
                print "[Command]Staff add executed"
              else:
                cl.sendText(msg.to,"Perintah Ditolak.")
                cl.sendText(msg.to,"Failed! please contact owner")
...
#--------===---====--------------
        ...
        #-------------Fungsi Jam Update Finish-------------------#
              ...
              if msg.from_ in admin:
                cl.sendText(msg.to, "Berikut kami akan menampilkan siapa saja yang membaca pesan ini")
                try:
                ...
                #print wait2
                 ...
                 if msg.from_ in admin:
                    if msg.to in wait2['readPoint']:
                        ...
                        cl.sendText(msg.to, "||Pembaca||%s\n\n\n>Baru saja membaca<\n%s-=SMULE MUSIC ACADEMY=-\n\n\n*SMA-BOT*\nSupport:\n•Afterlost\n•Enemy\nOwner bot :http://line.me/ti/p/~22_26_27\n\n[%s]" % (wait2['readMember'][msg.to],chiya,setTime[msg.to]))
                    else:
                        cl.sendText(msg.to, "Ketik .Dahulu Baru ketik,")
#-----------------------------------------------
...
#-----------------------------------------------
    ...
    #-------------Fungsi Leave Group Start---------------#
            ...
            elif msg.text in ["Keluar"]: #Semua Bot Ninggalin Group Kecuali Bot Induk
              if msg.from_ in admin:
                if msg.toType == 2:
                    ginfo = cl.getGroup(msg.to)
                    try:
    ...
    #-------------Fungsi Tag All Finish---------------#
            ...
            elif msg.text in [",,,"]: #Semua Bot Ngelike Status Teman
              if msg.from_ in owner:
                print "[Command]Like executed"
  ...
  #-----------------End-----------
            elif msg.text in ["Assalamualaikum","Assalamualaikum wr wb"]:
                ki.sendText(msg.to,"Waalaikum salam kakak")
                kk.sendText(msg.to,"waalaikum salam wr wb􏿿")
                kc.sendText(msg.to,"Waalaikum salam")
                cl.sendText(msg.to,"Waalaikum salam wr wB")
#-----------------------------------------------
            elif msg.text in ["Salam kenal","Salken","Salken All","Salken Semua"]:
                ki.sendText(msg.to,"Ya kakak salam kenal juga ya")
                kk.sendText(msg.to,"Salam kenal juga , jangan lupa kenalan dg yg lain")
                kc.sendText(msg.to,"Salam kenal juga kk")
            elif msg.text in ["Admin","Pengurus","Staff"]:
                ki.sendText(msg.to,"*BERIKUT ADALAH PENGURUS UTAMA SMA-SMULE MUSIC ACADEMY*\n\n+Owner : Zall[Enemy]\n+Founder : Winz [Chubby]\n+Co Founder : Nur [Ecek]\n+Leader : Siti Aisyah [Boss Coin]\n+Co Leader : Dian pw [Embem]\n+Admin : Wulan [Bawell]\n+Admin : Andra [Manyun]\n+Leader Group Facebook : Girman [Ecek]")
                kk.sendText(msg.to,"*BERIKUT ADALAH TEAM ADMIN*\n+Interview : Deden [Shipit]\n+Editor : Andika [Kngn band]\n+")
                kc.sendText(msg.to,"*BERIKUT ADALAH LEADER CLASS*\n+Leader Class Rock : Bangyon [Tukang gorengan]\n+Leader clasa pop : Dian pw [Embem]\n+Leader class Dangdut : Irma Rismayanti [Neng ir]\n+Mentor : Zall [Enemy]\n+Assisten Leader Collab : Poetri [Chan Caem Bla'em Bla'em]")
            elif msg.text in ["Rules","Peraturan"]:
                ki.sendText(msg.to,"+Peraturan Di room+\n+Wajib Ditaati+")
                kk.sendText(msg.to,"+Dilarang Membawa Masalah Pribadi Ke Group\n+Dilarang Spam panggilan Melebihi 2x\n+Dilarang share konten yg berbau politik,Pornografi/Porno Aksi\n+Dilarang Berbicara jorok/Kasar dan membuat kerusuhan digroup\n+Dilarang Membuat Note Kecuali Pengurus\n+Dilarang Mengubah nama/Gambar Group\n+Dilarang mengyndang Orang ke group Tanpa seizin pengurus\n+Dilarang Spam Chatt/Sicker (Kirim 5+ Sticker dalam waktu kurang dari 1menit dianggap Spam\n+Dilarang Baper/Mudah dibawa perasaan\n+Left/Keluar dari group 2x tanpa izin tidak bisa masuk kembali")
                kc.sendText(msg.to,"Bagi Anggota Yg Tidak menaati peraturan,Akan mendapat teguran 1-3x Kick/Dikeluarkan Jika Mendapat teguran 3x ")
            elif msg.text in ["Siang","Malam","Pagi","Sore"]:
                ki.sendText(msg.to,"iya kakak")
                kk.sendText(msg.to,"iya kakak, apakabar")
                kc.sendText(msg.to,"iya kakak, hallo")
            elif msg.text in ["Welcome"]:
                ki.sendText(msg.to,"Selamat datang di Group Kami")
                kk.sendText(msg.to,"Pengurus")
                kc.sendText(msg.to,"Rules")
#-----------------------------------------------
            elif msg.text in ["Sss"]:
...
#-----------------------------------------------
       ...
       #-------------Fungsi Respon Start---------------------#
              ...
              if msg.from_ in admin:
                cl.sendText(msg.to,"Syntax error")
                ki.sendText(msg.to,"Syntax error")
                kk.sendText(msg.to,"Syntax error")
                kc.sendText(msg.to,"Syntax error")
                ks.sendText(msg.to,"Syntax error")
                cl.sendText(msg.to,"Semua Bot Errror, Kaya yang Buat,Bos")
      ...
      #-------------Fungsi Banned Send Contact Finish------------------#
              ...
              cl.sendMessage(msg)
              cl.sendText(msg.to,"======================")
              cl.sendText(msg.to,"BOT PROTECT BY:ZALL")
...
#---------------------
        ...
        if op.type == 15:
          if op.param2 in Bots:
             return
          random.choice(KAC).sendText(op.param1, "GOOD BYE :v ")
    ...
    for zx in range(0,500):
      ...
      if hasil['result']['posts'][zx]['postInfo']['liked'] == False:
        try:
          ...
          cl.comment(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],"👉Auto Like by ⭐⭐ZALLs⭐⭐👈\n\n™SMULE MUSIC ACADEMY™")
          ki.like(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],likeType=1001)
          ki.comment(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],"AUTO LIKE BY ZAL http://line.me/ti/p/~22_26_27")
          print "Like"
        except:
          pass
      else:
        ...
        if hasil['result']['posts'][zx]['postInfo']['liked'] == False:
            if hasil['result']['posts'][zx]['userInfo']['mid'] in owner:
                try:
                    ...
                    cl.comment(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],"AUTO LIKE BY ZALL http://line.me/ti/p/~22_26_27")
                    print "Like"
                except:
                    pass
            else:
